...
<label for="collapse-section8" aria-hidden="true">V1.5.2 / 10-Oct-2024</label>
<div>
...
## Contents
  ...
  Headline
  --------
  Add missing argument in LL_ADC_StartCalibration() for STM32G4xx products
  Add DisableDeepPowerDown() for STM32G4xx products
...
<label for="collapse-section7" aria-hidden="true">V1.5.1 / 09-Nov-2023</label>
<div>
...
## Contents
  ...
  Headline
  --------
  Protect double ADC configuration
  Relocate include file list in DRP1M1 configuration file
...
<label for="collapse-section6" aria-hidden="true">V1.5.0 / 27-Jan-2023</label>
<div>
...
## Contents
  ...
  Update comments, code clean, unused code removal
  Addition of division by zero protection
  Test TCPP version before trying to open sink gate driver
...
## Contents
  ...
  In case of false OCP detection when in SRC mode, attempt to reopen Provider path without triggering the Error Recovery mechanism at protocol level
